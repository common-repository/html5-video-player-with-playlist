...
(function (a, b) {
	...
	b.pager[a].prototype.getDisplay = function () {
		if (this.options.build) {
			this.context.append('      <div class="html5playerer-' + a + '-playlist-pager ui-widget-header">   <div style="float:right; padding:7px;"><a href="http://html5plus.svnlabs.com/shop/html5-video-player-with-playlist/" target="_blank"><img src="http://html5mp3player.googlecode.com/svn/trunk/images/logo.gif" width="20" border="0" alt=""></a>&nbsp;<a href="https://twitter.com/HTML5MP3Player" target="_blank" title="Twitter"><img src="http://html5mp3player.googlecode.com/svn/trunk/images/twitter.png" border="0" width="20"></a>&nbsp;<a href="https://www.facebook.com/Html5Mp3Player" target="_blank" title="Facebook"><img src="http://html5mp3player.googlecode.com/svn/trunk/images/facebook.png" border="0" width="20"></a>&nbsp;<a href="http://html5.svnlabs.com" target="_blank" title="HTML5 Video Player with Playlist"><img src="http://html5mp3player.googlecode.com/svn/trunk/images/link-icon.png" border="0" width="20"></a></div>     <div class="html5playerer-' + a + '-playlist-pager-left">          <a href="#" class="html5playerer-' + a + "-playlist-pager-link html5playerer-" + a + "-playlist-pager-prevpage minplayer-" + a + '-button ui-state-default ui-corner-all">            <span class="ui-icon ui-icon-circle-triangle-w"></span>          </a>        </div>        <div class="html5playerer-' + a + '-playlist-pager-right">          <a href="#" class="html5playerer-' + a + "-playlist-pager-link html5playerer-" + a + "-playlist-pager-nextpage minplayer-" + a + '-button ui-state-default ui-corner-all">            <span class="ui-icon ui-icon-circle-triangle-e"></span>          </a>        </div>      </div>')
		}
